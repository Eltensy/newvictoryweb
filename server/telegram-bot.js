...
Я бот для связывания Telegram аккаунта с платформой Victory.

*🔗 Как привязать аккаунт:*

1️⃣ Войдите на сайт Victory
...
bot.onText(/^\/help$/i, async (msg) => {
  ...
  const helpMessage = `
📚 *Справка по боту Victory*

*🔗 Привязка аккаунта:*
1. Зайдите на сайт Victory
...
*❓ Нужна помощь?*
Обратитесь в поддержку на сайте Victory.
