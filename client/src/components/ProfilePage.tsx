  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center">
        <Card className="backdrop-blur-md bg-background/80 border-primary/10 p-8">
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">Войдите в систему для доступа к профилю</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      ...
      <EnhancedHeader
        ...
        onMySubmissionsClick={() => setLocation('/my-submissions')}
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* User Info Header */}
        <Card className="backdrop-blur-md bg-background/80 border-primary/10 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="backdrop-blur-md bg-background/80 border-primary/10">
              <CardContent className="p-6 space-y-3">
                <h3 className="text-sm font-medium text-muted-foreground mb-4">Интеграции</h3>
